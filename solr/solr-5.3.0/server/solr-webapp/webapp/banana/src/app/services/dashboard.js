...
function (angular, $, kbn, _, config, moment, Modernizr) {
  ...
  module.service('dashboard', function($routeParams, $http, $rootScope, $injector, $location,
    ...
    $rootScope.myFn = function(query) {
        var language;
        $.ajax({
                type: "GET",
                async: false,
                url: "https://translate.yandex.net/api/v1.5/tr.json/detect?key=trnsl.1.1.20151213T022138Z.00f3f916f770556c.c7ea409c76ebb5c5b65502fb1f2cf13a84c85849&text=' + query",
